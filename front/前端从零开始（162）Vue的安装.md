...
使用 CDN 的方式引入`Vue`更加方便、快捷。以下推荐几个比较稳定的 CDN。

1. [https://cdn.staticfile.org/vue/2.2.2/vue.min.js](https://cdn.staticfile.org/vue/2.2.2/vue.min.js)
2. [https://unpkg.com/vue/dist/vue.js](https://unpkg.com/vue/dist/vue.js)
3. [https://cdnjs.cloudflare.com/ajax/libs/vue/2.1.8/vue.min.js](https://cdnjs.cloudflare.com/ajax/libs/vue/2.1.8/vue.min.js)
4. [https://cdn.jsdelivr.net/npm/vue/dist/vue.js](https://cdn.jsdelivr.net/npm/vue/dist/vue.js)
...
安装完成后可以查看到 demo 目录下多了 node_module/vue 文件夹。说明`Vue`成功安装。
