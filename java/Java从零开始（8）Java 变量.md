---
title: Java从零开始（8）Java 变量
zhihu-url: https://zhuanlan.zhihu.com/p/399982241
...
适当地使用常量可以提高代码的安全性和可维护性。例如，我们可以在程序中声明一个表示网站名称的常量： `final String SITE_NAME = "";`，这样在所有需要用到网站名称的地方，都调用这个常量即可。这样既保证了其值不可修改，提高了代码的安全性，又统一了调用方的规范。
