...
![](//img.mukewang.com/wiki/5e987bb509ddbacc03240267.jpg)
...
![](//img.mukewang.com/wiki/5e987bce09d3422408140130.jpg)
...
![](//img.mukewang.com/wiki/5e987bec090f25f707700436.jpg)
...
![](//img.mukewang.com/wiki/5e987c0609ebe2f606050244.jpg)

打开后会显示一个 ecplise 的欢迎页面。点击 **Create a Hello World application**。按照向导步骤即可创建并运行我们的 Hello World 程序。

![](//img.mukewang.com/wiki/5e987c20099db5af10240768.jpg)

右侧区域为创建一个`Hello World`程序的整体步骤。

![](//img.mukewang.com/wiki/5e987c3709ffd79b14400900.jpg)
...
![](//img.mukewang.com/wiki/5e987dbe0985ca9b08090559.jpg)

下图中`Project name`为项目名称。将项目命名为 `hello`（项目名的命名规范：全小写英文），并选择 JRE 为 JavaSE-14，点击 Finish 按钮。

![](//img.mukewang.com/wiki/5e987c740991a55708120721.jpg)

这时会出现一个是否创建模块信息的弹窗，点击 `Don't Create` 按钮。

![](//img.mukewang.com/wiki/5e987c8b099ed11d05870361.jpg)

#### 第二步：在工程下新建一个类

在刚刚创建好的工程下的 src 目录上，点击右键 -> New -> Class

![](//img.mukewang.com/wiki/5e987ca00988fe6605600656.jpg)

将类名命名为 HelloWorld，并且选择**创建 main 方法**的复选框。点击 `Finish` 按钮

![](//img.mukewang.com/wiki/5e987cb7095acee105900632.jpg)
...
![](//img.mukewang.com/wiki/5e987cdb09308ab204180173.jpg)

#### 第四步：运行 Java 应用

在源代码文件 HelloWorld.java 上点击右键（或直接在源代码中点击右键），选择 Run As -> Java Application

![](//img.mukewang.com/wiki/5e987cf809ebc7f407330750.jpg)

我们可以看到控制台已成功打印 Hello World

![](//img.mukewang.com/wiki/5e987e100988a73804800208.jpg)
...
![](//img.mukewang.com/wiki/5e987d0f098930b902920242.jpg)

在左侧列表选择 General -> Appearance -> Colors and Fonts

![](//img.mukewang.com/wiki/5e987d270943799c06300587.jpg)

在右侧选择 Basic -> Text Font

![](//img.mukewang.com/wiki/5e987d38092f127806300587.jpg)

点击 `Edit` 按钮，可选择理想的字体、字号

![](//img.mukewang.com/wiki/5e987d4b0945ec9b04450270.jpg)
...
![](//img.mukewang.com/wiki/5e987d7f0959221807490698.jpg)
