...
```
启动项目
![](https://cdn.guojiang.club/FmgrK2C6iNFqaMhaS-rY6mSZ0KHq)
我们从 http://127.0.0.1:8000 写入一条数据，再从 http://127.0.0.1:9000 读取该条数据
![](https://cdn.guojiang.club/Fh87ZMblm7bXn6D8qPqRpTcFe5JA)

![](https://cdn.guojiang.club/FlZZuhbuPObHkejQfLoM29Fu5Rpb)
...
```
修改配置后启动
![](https://cdn.guojiang.club/Fv9jixi_vpoN2Iu9ouh8f62neIuu)
#### 返回 json 数据
...
```
修改配置后启动
![](https://cdn.guojiang.club/FlUkVRErid_xS3IgTRTW5btJalBC)
...
如下图所示
![](https://cdn.guojiang.club/FqQE6kdt9mKQiUl3297zRWt66soy)
