...
没有使用网关之前，服务端请求多个节点
![](https://cdn.guojiang.club/FkfvtsQD5vL5V8J8ybJGdzj5rNgV)

使用网关后
![](https://cdn.guojiang.club/FllBlUAEDwZpM5vcshRBHcJkCjFL)
## 下载地址
...
![](https://cdn.guojiang.club/FigtJ_OH0JwHuAPs3UQ_xmintqJr)
...
![](https://cdn.guojiang.club/FuRrueNmzdYO6g3yAbCvDnpaD-7Y)

我们选择其中一个，在浏览器中输入 http://localhost:2900/_framework/api/_version 从路由上看该接口是查询产品的版本信息，显示如下
![](https://cdn.guojiang.club/FkOZf_2La7P6sDNH8ge7MOeVBXkR)
...
```
改完后启动
![](https://cdn.guojiang.club/FkDOOUTSem4o-8nEylBUs9x5XwQT)
...
```
![](https://cdn.guojiang.club/FoxmU4ocbIiOd30NH9r67nDw9lzO)
